start erl -sname sail_web -pa ebin -pa debs/erlang_template/ebin -pa deps/cowboy/ebin -pa deps/jsx/ebin -pa apps/sail_server/ebin -pa apps/sail_web/ebin -s sail_web_app -s reloader
sleep 5
if "%1"=="-f" goto FIREFOX
